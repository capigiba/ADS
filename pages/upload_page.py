...
def render_upload_section():
    ...
    with left:
        ...
        weight1 = st.number_input("Weight 1", min_value=0.0, max_value=1.0, step=0.01, value=0.5)
        weight2 = st.number_input("Weight 2", min_value=0.0, max_value=1.0, step=0.01, value=0.5)
    ...
    with right:
        st.subheader("Right Section (TBD)")
